                        ...
                        <div class="main-banner">
                            <div class="d-sm-flex justify-content-between">
                                ...
                                <div class="mt-5 mt-lg-0">
                                    <img src="{{asset('storage/'.$features->image)}}" alt="marsmello" class="img-fluid" data-aos="zoom-in-up">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    @foreach($characteristics as $course)
                        <div class="col-sm-4 text-center text-lg-left">
                            <div class="services-box" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
                                <img src="{{asset('storage/'.$course->icon)}}" width="50" height="50" alt="integrated-marketing" data-aos="zoom-in">
                                <a href="">
                ...
                <div class="row pt-5 mt-5 pb-5 mb-5">
                    ...
                    <div class="col-sm-3">
                        <div class="d-flex py-3 my-3 my-lg-0 justify-content-center" data-aos="fade-up">
                            ...
                            <div>
                                <h4 class="font-weight-bold text-dark mb-0"><span class="">{{$skills->sub_title}}</span></h4>
                    ...
                    <div class="col-sm-3">
                        <div class="d-flex py-3 my-3 my-lg-0 justify-content-center" data-aos="fade-down">
                            ...
                            <div>
                                <h4 class="font-weight-bold text-dark mb-0"><span class="">{{$skills->description}}</span></h4>
